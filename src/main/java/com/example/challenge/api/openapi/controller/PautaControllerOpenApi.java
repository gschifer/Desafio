...
public interface PautaControllerOpenApi {
    ...
    ResponseEntity<List<PautaDTO>> getPautas();
    ...
    ResponseEntity<PautaDTO> getPauta(@ApiParam(value = "ID da pauta", example = "1") Long pautaId);
    ...
    ResponseEntity<List<PautaDTO>> getPautasEmpatadas();
    ...
    ResponseEntity<List<PautaDTO>> getPautasAprovadas();
    ...
    ResponseEntity<List<PautaDTO>> getPautasReprovadas();
    ...
    ResponseEntity<PautaDTO> reabrePauta(@ApiParam(value = "ID da pauta", example = "1", required = true) Long pautaId);
    ...
    ResponseEntity<PautaDTO> salvaPauta(@ApiParam(name = "Corpo de requisição", value = "Representação de uma nova pauta",
